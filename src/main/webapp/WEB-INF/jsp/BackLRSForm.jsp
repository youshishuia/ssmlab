                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <h4 class="card-title"> 预约列表</h4>
                            <form action = "BackLRSFormsearch" method = "post">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <c:choose>
                                        <c:when test="${not empty formViewList}">
                                            <c:forEach items="${formViewList}" var="formView" varStatus="vs">
                                                <tr>
                                                    <td>
                                                            ${formView.formid}
                                                    </td>
                                                    ...
                                                    <td>
                                                            ${formView.appointment}
                                                    </td>
                                                    <td>
                                                            ${formView.pass}
                                                    </td>
                                                    <td >
                                                        <form action="BackLRSFormEdit1" method="post">
                                                    ...
                                                    <td class="text-right">
                                                        <form action="Backformcancer" method="post">
                                                            <input type="hidden" name="num" value="${vs.index}"/>
                                                            <button href="#" class="btn btn-neutral btn-icon btn-round btn-lg">
                                    ...
                                    <tr>
                                        <td colspan="12">
                                            <div class="button-container">
                                                    <a href="BackLRSFormsub" class="btn btn-neutral btn-icon btn-round btn-lg">
                                                        <i class="now-ui-icons arrows-1_minimal-left"></i>
                                                    </a>
                                                    <a href="BackLRSFormadd" class="btn btn-neutral btn-icon btn-round btn-lg">
                                                        <i class="now-ui-icons arrows-1_minimal-right"></i>
                                                    </a>
                                                    <a href="BackLRSHelp" class="btn btn-neutral btn-icon btn-round btn-lg text-right">
