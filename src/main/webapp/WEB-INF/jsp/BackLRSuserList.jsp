                                        ...
                                        <c:when test="${not empty userList}">
                                            <c:forEach items="${userList}" var="user" varStatus="vs">
                                                <tr>
                                                    ...
                                                    <td class="text-right">
                                                        <form action="BackLRSuserEdit1" method="post">
                                    ...
                                    <tr>
                                        <td colspan="12">
                                            <div class="button-container">
                                                <a href="BackLRSuserListsub" class="btn btn-neutral btn-icon btn-round btn-lg">
                                                    <i class="now-ui-icons arrows-1_minimal-left"></i>
                                                </a>
                                                <a href="BackLRSuserListadd" class="btn btn-neutral btn-icon btn-round btn-lg">
