                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <form action = "LRSlabsearch" method = "post">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <tbody>
                                        <c:choose>
                                            <c:when test="${not empty labList}">
                                                <c:forEach items="${labList}" var="lab" varStatus="vs">
                                                    <tr>
                                                        <td>
                                                                ${lab.id}
                                                        </td>
                                    ...
                                    <tr>
                                        <td colspan="12">
                                            <div class="button-container">
                                                    <a href="LRSlabsub" class="btn btn-neutral btn-icon btn-round btn-lg">
                                                        <i class="now-ui-icons arrows-1_minimal-left"></i>
                                                    </a>
                                                    <a href="LRSlabadd" class="btn btn-neutral btn-icon btn-round btn-lg">
